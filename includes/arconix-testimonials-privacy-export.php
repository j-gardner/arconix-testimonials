...
if ( !class_exists('Arconix_Testimonials_Privacy_Export' ) ) {
    ...
    class Arconix_Testimonials_Privacy_Export {
         ...
         * @since 1.3
         */
        static function act_data_exporter( $email_address, $page ) {
         ...
         * @since 1.3
         */
        static function get_arconix_testimonial_data( $email_address, $custom_data ) {
            $personal_data   = array();
            
            global $wpdb;
            $act_details_to_export = apply_filters( 'act_personal_export_testimonial_details_prop', array(
