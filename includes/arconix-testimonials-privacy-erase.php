...
if ( !class_exists('Arconix_Testimonials_Privacy_Erase' ) ) {
    ...
    class Arconix_Testimonials_Privacy_Erase {
         ...
         * @since 7.8
         */
        static function act_data_eraser( $email_address, $page ) {
         ...
         *
         * @param strig $email_address - Email address
         * @param array $custom_data_key - Testimonial information
         * @global $wpdb
         * @since 7.8
         */
        static function remove_testimonial_personal_data( $email_address, $custom_data_key ) {
            global $wpdb;
            ...
            $props_to_remove_testimonial = apply_filters( 'act_privacy_remove_personal_data_props', array( 
                '_act_url'   => 'text',
                '_act_email' => 'email' ), $email_address );
